...
date: "2024-06-12"
excerpt: "Fix Hyprland window tracking that fails with 'window not detected' errors. Learn how to solve systemd service socket issues by auto-discovering socket files instead of caching Hyprland Instance Signature at startup."
