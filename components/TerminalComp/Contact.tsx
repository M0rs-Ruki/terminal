...
const MailIcon: React.FC = () => (
  <svg
    ...
    className="transition-all duration-300 group-hover:stroke-green-400 group-hover:scale-110"
    aria-hidden="true"
  >
      ...
      >
        ...
        >
          <p className="text-gray-300 font-mono text-xs sm:text-sm leading-relaxed">
            ...
            connection...
            <span
              className="inline-block w-1.5 h-3 sm:w-2 sm:h-4 bg-green-400 ml-1 animate-pulse"
              aria-hidden="true"
            ></span>
          </p>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {copiedEmail && (
                    <p
                      className="text-green-400 text-xs font-mono animate-fade-in"
                      role="status"
                      aria-live="polite"
                    >
                      ✓ Copied to clipboard
                ...
                <div
                  className="text-gray-500 group-hover:text-green-400 transition-colors duration-300 flex-shrink-0"
                  aria-hidden="true"
                >
                  <svg
                    width="14"
            ...
            >
              {socialLinks.map((social, index) => (
                ...
                >
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-green-400/0 via-green-400/5 to-green-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg sm:rounded-xl"
                    aria-hidden="true"
                  ></div>
                </a>
              ))}
