...
const TerminalWindow: React.FC<TerminalWindowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-3 bg-black/30 border-b border-green-400/20">
        ...
        <div
          className={`w-2 h-2 rounded-full ${
            isActive ? "bg-green-400 animate-pulse" : "bg-green-400/30"
          }`}
          aria-hidden="true"
        ></div>
      </div>
      ...
      {isActive && (
        <div
          className="absolute inset-0 bg-gradient-to-r from-green-400/10 via-transparent to-green-400/10 pointer-events-none"
          aria-hidden="true"
        ></div>
      )}
    </div>
    ...
    <section className="relative p-6" aria-label="Technical skills">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div
            className={`mt-4 text-green-300/80 font-mono transition-all duration-1000 delay-300 ${
              terminalStarted
                ? "opacity-100 translate-y-0"
